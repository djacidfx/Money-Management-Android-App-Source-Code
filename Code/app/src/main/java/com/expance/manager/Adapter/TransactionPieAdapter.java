...
public class TransactionPieAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (itemViewType == 0) {
            ...
            Trans trans = this.list.get((position - this.stats.size()) - 1).getTrans();
    ...
    public int getItemCount() {
        ...
        return this.list.size() + this.stats.size() + 1;
    }
    ...
    public int getItemViewType(int position) {
        ...
        if (position <= this.stats.size()) {
            return 3;
        }
        return this.list.get((position - this.stats.size()) - 1).isDailyHeader() ? 1 : 0;
    }
