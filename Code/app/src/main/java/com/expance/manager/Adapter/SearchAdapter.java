    ...
    public void onBindViewHolder(RecyclerView.ViewHolder var1, int var2) {
        if (this.getItemViewType(var2) == 0) {
            ...
            if (this.transList.size() > 1) {
                var12.titleLabel.setText(this.context.getResources().getString(2131821182, new Object[]{this.transList.size()}));
            } else {
                var12.titleLabel.setText(this.context.getResources().getString(2131821180, new Object[]{this.transList.size()}));
            }
        } else {
