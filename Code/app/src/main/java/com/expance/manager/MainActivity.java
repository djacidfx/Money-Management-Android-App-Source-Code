...
//        }
    ...
    public void loadInterstitialAds() {
        InterstitialAd.load(this, "ca-app-pub-2916714021613915/5513595215", new AdRequest.Builder().build(), new InterstitialAdLoadCallback() { // from class: com.ktwapps.walletmanager.MainActivity.4
